      ...
      <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          <a
            ...
            href="https://wa.me/message/5AH474CN5N4PP1"
            target="_blank"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
          ...
          <a
            ...
            href="https://www.instagram.com/law_tricks?igsh=cGM4ZzQ0ZWVhd2lu&utm_source=qr"
            target="_blank"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
        ...
        <div className="sm:text-[12px]">
          | Copyright &copy; <span>2024 Dev Ola </span> All rights reserved
          <a href="#"></a> |
        </div>
      </div>
    </div>
